...
public abstract class Classifier implements Cloneable, Serializable {
    ...
    public abstract String trainalldata(boolean[] isCategory, double[][] features, double[] labels);
    public abstract double predictvalue(double[] features,String bayesmodel);
