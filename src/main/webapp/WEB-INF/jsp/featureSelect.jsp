...
ul li{height:25px;width:10%; float:left;}
</style> 
...
<div class="layui-layout layui-layout-admin kit-layout-admin" >
             <ul class="layui-nav  kit-nav" >
               <li class="layui-nav-item" id="INPUT_tab1" onClick="setTab('INPUT',1,3)"style="margin-top:-5px;padding:0;" >mulTarget</li>
                <li class="layui-nav-item" id="INPUT_tab2" onClick="setTab('INPUT',2,3)" style="margin-top:-10px;padding:0;">PCA</li>
                 <li class="layui-nav-item" id="INPUT_tab3" onClick="setTab('INPUT',3,3)" style="margin-top:-10px;padding:0;">ICA</li>
            </ul> 
        </div>
...
<div class="layui-inline">
    ...
    <div class="layui-input-inline">
      ...
      <button class="layui-btn" style="text-align:right;">选择</button>
      </div>
</div>
</form>
</div>
   ...
   <div class="layui-inline">
    ...
    <div class="layui-input-inline">
      <select name="samplingRate" >
       ...
       <button class="layui-btn" style="float:right;">选择</button>
      </div>
</div>
</form>
</div>
